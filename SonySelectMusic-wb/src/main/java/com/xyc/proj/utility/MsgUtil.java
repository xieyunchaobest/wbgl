...
public class MsgUtil {
	public static void sendTemplateMsg(String templateId,String openId,String url,String title,String taskName,String state,String remark) {
		Map m=new HashMap();
		m.put("touser", openId);
		...
		com.alibaba.fastjson.JSONObject res=WeixinUtil.httpRequest(Constants.URL_SEND_TEMPLEATE_MSG+Constants.WE_CHAT_ACCESS_TOKEN, "POST", msg);
		System.out.println(com.alibaba.fastjson.JSONObject.toJSONString(res));
		
	}
	
	public static void main(String args[]) {
		new MsgUtil().sendTemplateMsg("3uFcnQniJnbO-W_JNakYo9gEiZlsNESM6Iv0d4-r7nk", "o74xjwyDhHcr083Z253UxEQZ08vo", "www.baidu.com", "您有新的任务", "和平区xxxxx", "代办", "点击查看详情");
	}
}
